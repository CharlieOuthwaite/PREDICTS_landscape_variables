...
# remove anything above and below the quantiles
result[which(pred_tab$homogen < Qhomo[1]), ] <- NA
result[which(pred_tab$homogen > Qhomo[2]), ] <- NA
...
ggplot(data = pred_tab) +
  geom_line(aes(x = homogen_ori, y = PredMedian), col = c("#1874CD")) +
  geom_ribbon(aes(x = homogen_ori, ymin= PredLower, ymax = PredUpper), fill = c("#1874CD"), alpha = 0.3) +
  ...
  theme(panel.grid = element_blank(),
        legend.position = c(0.8,0.8), legend.title = element_blank(),
        aspect.ratio = 1, text = element_text(size = 16)) 

ggsave(filename = paste0(outdir, "/Homogen_tropabun.pdf"), width = 4, height = 4, unit = "in")


## now the temperate data
...
ggsave(filename = paste0(outdir, "/Homogen_tempabun.pdf"), width = 4, height = 4, unit = "in")


#### now richness predictions ####
...
ggsave(filename = paste0(outdir, "/HomogenLU_RichTrop.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/Homogen_RichTemp.pdf"), width = 4, height = 4, unit = "in")
...
ggplot(data = pred_tab) +
  ...
  scale_x_continuous(breaks = c(0, 200000, 400000, 600000), labels = c("0", "200000", "400000", "600000"),
                     limits = c(0, 650000))

ggsave(filename = paste0(outdir, "/FertLU_Richtrop.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/FertLU_Richtrop_reducedlims.pdf"), width = 4, height = 4, unit = "in")



### Temperate richness UI ###
...
ggsave(filename = paste0(outdir, "/FertUI_abuntemp.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/FertUI_abuntemp_reducedlims.pdf"), width = 4, height = 4, unit = "in")
...
ggplot(data = pred_tab_3) +
  ...
  theme_bw() +
  theme(panel.grid = element_blank(),
        legend.position = c(0.8, 0.15), legend.title = element_blank(),
        legend.text = element_text(size = 12),
        aspect.ratio = 1, legend.background = element_blank(),
        text = element_text(size = 16)) +
  scale_x_continuous(breaks = c(0, 200000, 400000, 600000), labels = c("0", "200000", "400000", "600000"),
...
ggsave(filename = paste0(outdir, "/Fert_abuntemp.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/Fert_abuntemp_reducedlims.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/Supp_Abun_LUUI.pdf"), width = 8, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/Supp_Rich_LUUI.pdf"), width = 8, height = 4, uni = "in")
...
##%######################################################%##
#                                                          #
####              Percentage NH Abundance               ####
#                                                          #
##%######################################################%##


# temperate, no interaction
...
ggsave(filename = paste0(outdir, "/PercNH_Abuntemp.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/PercNHLU_tropRich.pdf"), width = 4, height = 4, unit = "in")
...
ggsave(filename = paste0(outdir, "/Supp_Richness_percNHUI_trop.pdf"), width = 4, height = 4, unit = "in")
...
# predict the result
result2 <- PredictGLMER(model = srmod_temp$model, data = pred_tab2, se.fit = TRUE, seMultiplier = 1.96)
...
# SR plot = full range
ggplot(data = pred_tab) +
  geom_line(aes(x = landc_ori, y = PredMedian), col = c("#CD950C")) +
  geom_ribbon(aes(x = landc_ori, ymin= PredLower, ymax = PredUpper), fill = c("#CD950C"), alpha = 0.3) +
  #facet_grid(~realm)+
  ylim(c(0,300)) +
  xlim(c(0, 11)) +
...
ggsave(filename = paste0(outdir, "/Landcovers_abuntemp.pdf"), width = 4, height = 4, unit = "in")
...
##%######################################################%##
#                                                          #
####    Abundance/richness, tropical landcovers UI      ####
#                                                          #
##%######################################################%##
...
ggplot(data = pred_tab) +
  ...
  #geom_rug(data = landcov, aes(x = V1, col = Use_intensity), size = 0.1) +
  #facet_grid(~realm) +
  ylim(c(0, 20)) +
  #xlim(c(0, 10)) +
  xlab("Number of Landcovers") +
...
ggsave(filename = paste0(outdir, "/LandcoversUI_richtrop.pdf"), width = 4, height = 4, unit = "in")
...
# predict the result
result2 <- PredictGLMER(model = abmod_trop$model, data = pred_tab2, se.fit = TRUE, seMultiplier = 1.96)
...
ggplot(data = pred_tab2) +
  geom_line(aes(x = landc_ori, y = PredMedian, col = Use_intensity)) +
  geom_ribbon(aes(x = landc_ori, ymin= PredLower, ymax = PredUpper, fill = Use_intensity), alpha = 0.3) +
  #geom_rug(data = landc, aes(x = V1, col = Use_intensity), size = 0.1) +
  #facet_grid(~realm) +
  ylim(c(0, 300)) +
  xlim(c(0, 10)) +
  xlab("Number of Landcovers") +
...
ggsave(filename = paste0(outdir, "/LandcoversUI_Abun_trop.pdf"), width = 4, height = 4, unit = "in")
